  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start justify-start text-xs text-gray shadow-md">
        <div className="rounded-lg bg-white shadow-[0px_4px_24px_rgba(29,_35,_46,_0.1)] w-[345px] min-h-[110px] flex flex-col p-6 box-border items-start justify-center">
          <div className="self-stretch flex flex-col items-start justify-start">
            ...
            <div className="self-stretch flex flex-col py-1 box-border items-start justify-start">
              ...
              <div className={styles.contentType}>
                ...
                />
                <span className={styles.trashcan} onClick={() => {setContentType(true)}}>
                  <Image
                    className={"relative"}
                    alt=""
                    src={trash}
            ...
            {!possibleCTA &&
              ...
              <div className={styles.contentType}>
                <input
                  ...
                  defaultValue="Small Posts (Tweets)"
                />
                <span className={styles.trashcan} onClick={() => {setPossibleCTA(true)}}>
                  <Image
                    className={"relative"}
                    alt=""
                    src={trash}
      ...
      <div className={styles.addContent} >
        {contentType &&
        <div className={styles.add} onClick={() => {setContentType(false)}}>
       ...
       {possibleCTA && 
       <div className={styles.add} onClick={() => {setPossibleCTA(false)}}>
        <span className={styles.trashcan}>
          <Image
            className={"relative"}
            alt=""
      ...
      <div className="absolute top-[400px] flex flex-row px-0 box-border items-center justify-center">
